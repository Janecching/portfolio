      ...
      <div className="lg:flex lg:justify-between lg:items-start lg:gap-5 mb-20">
        ...
        <div className="my-auto">
            ...
            <p className="mt-2 mb-4"> 
              - UPenn Computer Science <br />
              - 2x SWE Intern | 6x Hackathon Winner <br />
              - Seeking SWE Opportunities <br />
            </p>
            <div className="flex justify-center gap-2">
            <a href="https://drive.google.com/file/d/1RtFFPxesUYf4FZjp__Md4YwKc20Id0i2/view?usp=sharing" className='black_btn' download>Download Resume</a>
